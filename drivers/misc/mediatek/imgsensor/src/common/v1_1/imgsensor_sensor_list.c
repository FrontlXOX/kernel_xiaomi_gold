...
#endif
/* everpal port: 4.14 drivers (imx355/ov50c40/s5kjn1 ported); ov16a1qofilm+qtech
 * map onto existing AAC/SUNNY Inits (identical silicon 0x1641/0x1642) */
...
{S5KJN1SUNNY_SENSOR_ID, SENSOR_DRVNAME_S5KJN1SUNNY_MIPI_RAW, S5KJN1SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(OV50C40OFILM_MIPI_RAW)
{OV50C40OFILM_SENSOR_ID, SENSOR_DRVNAME_OV50C40OFILM_MIPI_RAW, OV50C40OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(OV16A1QOFILM_MIPI_RAW)
{OV16A1QOFILM_SENSOR_ID, SENSOR_DRVNAME_OV16A1QOFILM_MIPI_RAW, OV16A1Q_AAC_FRONT_MIPI_RAW_SensorInit},
#endif
#if defined(OV16A1QQTECH_MIPI_RAW)
{OV16A1QQTECH_SENSOR_ID, SENSOR_DRVNAME_OV16A1QQTECH_MIPI_RAW, OV16A1Q_SUNNY_FRONT_MIPI_RAW_SensorInit},
#endif
